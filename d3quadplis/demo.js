...
function showScatterPlot(data, category) {
    ...
    // the domain define the min and max variables to show. In this case, it's the min and max risk of items.
    ...
    .attr('transform', function (d) {
        return "translate(" + x(d.risk) + "," + y(d.rating) + ")";
    });
